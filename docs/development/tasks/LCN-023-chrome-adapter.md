...
Chrome เป็น secondary browser สำหรับ debug/cross-browser testing

## Planned capabilities

Chrome DevTools Protocol; common Browser API mapping

## Design notes

CDP backend; no Edge dependency; preserve Chrome-specific escape hatch
