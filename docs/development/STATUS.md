...
Current installed source MCP catalog: **119 tools**

Current running daemon MCP catalog: **118 tools** — restart required for LCN-043 activation
...
| Execution Ergonomics | ACTIVE | LCN-040+ | LCN-043 exact-commit GitHub CI correlation implementation in progress |
